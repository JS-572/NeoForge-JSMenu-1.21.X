    ...
    public static final Supplier<CreativeModeTab> VEGETABLES = CREATIVE_MODE_TAB.register("vegetables",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(Items.BEETROOT))
                    ...
                    .displayItems((itemDisplayParameters, output) -> {
                        ...
                        output.accept(ModItems.ORANGE_TOMATO.get());
                        output.accept(ModItems.YELLOW_HEIRLOOM_TOMATO.get());
                        output.accept(ModItems.BLUE_TOMATO.get());
                        output.accept(ModItems.PURPLE_TOMATO.get());
                        output.accept(ModItems.RED_BELL_PEPPER.get());
                        output.accept(ModItems.ORANGE_BELL_PEPPER.get());
                        output.accept(ModItems.YELLOW_BELL_PEPPER.get());
                        output.accept(ModItems.PURPLE_BELL_PEPPER.get());
                        output.accept(ModItems.RED_CHILI_PEPPER.get());
                        output.accept(ModItems.FILIUS_BLUE_PEPPER.get());
                        ...
                        output.accept(ModItems.BLACK_GARLIC.get());
                        output.accept(ModItems.CABBAGE.get());
                        output.accept(ModItems.RED_CABBAGE.get());
                        output.accept(ModItems.PURPLE_CABBAGE.get());
                        output.accept(ModItems.CAULIFLOWER.get());
                        output.accept(ModItems.ORANGE_CAULIFLOWER.get());
                        output.accept(ModItems.PURPLE_CAULIFLOWER.get());
                        output.accept(ModItems.BROCCOLI.get());
                        output.accept(ModItems.ROMANESCO.get());
                        output.accept(ModItems.RED_POTATO.get());
                        output.accept(ModItems.YELLOW_POTATO.get());
                        output.accept(ModItems.PURPLE_POTATO.get());
                        output.accept(ModItems.SWEET_POTATO.get());
                        output.accept(ModItems.PURPLE_SWEET_POTATO.get());
                        output.accept(ModItems.YELLOW_CARROT.get());
                        output.accept(ModItems.PURPLE_CARROT.get());
                        output.accept(ModItems.BLACK_CARROT.get());
                        ...
                        output.accept(ModItems.BLUE_CORN.get());
                        output.accept(ModItems.WHITE_CORN.get());
                        output.accept(ModItems.BROWN_RICE.get());
                        output.accept(ModItems.FORBIDDEN_RICE.get());
                        output.accept(ModItems.CHICKPEAS.get());
                        output.accept(ModItems.SPINACH.get());
                        output.accept(ModItems.KALE.get());
                        output.accept(ModItems.ARUGULA.get());
                        output.accept(ModItems.GINGER.get());
                        output.accept(ModItems.TURMERIC.get());
                        output.accept(ModItems.CREMINI.get());
                        output.accept(ModItems.SHIITAKE.get());
                        output.accept(ModItems.PORCINI.get());
                        output.accept(ModItems.PORTOBELLO.get());
                        output.accept(ModItems.ZUCCHINI.get());
                        output.accept(ModItems.YELLOW_ZUCCHINI.get());
                        output.accept(ModItems.CUCUMBER.get());
                        output.accept(ModItems.CELERY.get());
                        output.accept(ModItems.EGGPLANT.get());
                        output.accept(ModItems.BLACK_BEAUTY_EGGPLANT.get());
                        output.accept(ModItems.MAITAKE.get());
                        output.accept(ModItems.BLUE_CABBAGE.get());
                        output.accept(ModItems.YELLOW_CAULIFLOWER.get());
                        output.accept(ModItems.PINK_CAULIFLOWER.get());
                        output.accept(ModItems.PURPLE_BROCCOLI.get());
                        output.accept(ModItems.BLUE_GREEN_BROCCOLI.get());
                        output.accept(ModItems.WHITE_EGGPLANT.get());
                        output.accept(ModItems.BLACK_OLIVE.get());
                        output.accept(ModItems.BLACK_RADISH.get());
                        output.accept(ModItems.ADIRONDACK_BLUE_POTATO.get());
                        output.accept(ModItems.GOLDEN_BEETROOT.get());
                        output.accept(ModItems.PURPLE_BEETROOT.get());
                        output.accept(ModItems.BLUE_CARROT.get());
                        output.accept(ModItems.PURPLE_KALE.get());
                        output.accept(ModItems.BLACK_KALE.get());
                        output.accept(ModItems.RED_LEAF_LETTUCE.get());
                        output.accept(ModItems.BLACK_TUSCAN_CABBAGE.get());
                        output.accept(ModItems.PINK_PEPPERCORN.get());
                    }).build());
