...
public class Stars {
    public static final Star SUN = new Star("sun", "Sun", 0.0D, 0.0D, "Center of the solar system and the main source of heat and light.", null, SpaceDimensions.SUN, StarClass.G);
